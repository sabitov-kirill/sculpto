...
scl::shared<scl::shader_program> scl::gl::phong_material_shader {};
...
scl::shared<scl::shader_program> scl::gl::GetSingleColorMaterialShader() const
{
    if (single_color_material_shader == nullptr)
        single_color_material_shader = assets_manager::LoadShader("assets/shaders/single_color_geometry.glsl");
...
scl::shared<scl::shader_program> scl::gl::GetPhongMaterialShader() const
{
    if (phong_material_shader == nullptr)
        phong_material_shader = assets_manager::LoadShader("assets/shaders/phong_geometry_pass.glsl");
