...
namespace scl
{
    ...
    public:
         ...
         */
        renderer_camera(camera_projection_type ProjectionType)
        {
            this->ProjectionType = ProjectionType;
         ...
         */
        renderer_camera &Resize(int ProjectionWidth, int ProjectionHeight)
        {
         ...
         * \return self reference.
         */
        renderer_camera &Rotate(const vec3 &Axis, degrees Angle)
        {
            matr4 transform =
         ...
         * \return self reference.
         */
        renderer_camera &Move(const vec3 &MoveVector)
        {
            Position += MoveVector;
            Focus += MoveVector;
