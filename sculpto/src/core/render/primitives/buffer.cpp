...
scl::shared<scl::buffer> scl::buffer::Create(u32 BindingPoint, u32 Size)
{
    switch (render_context::GetApi())
    {
    case scl::render_context::api::OpenGL:  return CreateShared<scl::gl_buffer>(BindingPoint, Size);
...
scl::shared<scl::buffer> scl::buffer::Create(u32 BindingPoint, const void *Data, u32 Size)
{
    switch (render_context::GetApi())
    {
    case scl::render_context::api::OpenGL:  return CreateShared<scl::gl_buffer>(BindingPoint, Data, Size);
    case scl::render_context::api::DirectX: SCL_CORE_ASSERT(0, "This API is currently unsupported."); return nullptr;
    }
